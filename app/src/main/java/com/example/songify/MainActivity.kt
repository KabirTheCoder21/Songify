...
class MainActivity : AppCompatActivity() {
    ...
    companion object{
       ...
       var search : Boolean = false
        ...
        val currentTheme = arrayOf(R.style.coolPink,R.style.coolPurple,R.style.coolGreen,R.style.coolBlue,R.style.coolYellow)
        val currentThemeNav = arrayOf(R.style.coolPinkNav,R.style.coolPurpleNav,R.style.coolGreenNav,R.style.coolBlueNav,R.style.coolYellowNav)
        val currentGradient = arrayOf(R.drawable.gradient_pink,R.drawable.gradient_purple,R.drawable.gradient_green,R.drawable.gradient_blue,R.drawable.gradient_yellow)
        var sortOrder : Int =0
    ...
    private fun requestRunTimePermission() : Boolean
    {
       ...
       {
           ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.WRITE_EXTERNAL_STORAGE),15)
           return false
       }
        return true
    }
