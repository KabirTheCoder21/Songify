...
private fun setInitializeLayout() {
    ...
    private fun showBottomSheetDialog()
    {
        ...
        dialog.findViewById<LinearLayout>(R.id.min_15)?.setOnClickListener{
            ...
            if(min15)
            {
                if (isPlaying) {
                    pauseMusic()
                    if(min15 || min30 || min60) binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this,R.color.pink))
                }
            }
            }.start()
            dialog.dismiss()
